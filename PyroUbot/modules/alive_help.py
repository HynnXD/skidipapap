...
<blockquote>{bot.me.mention}
    status: {status} 
       {psr} expired_on: {exp} 
        ...
        <blockquote><b>USERBOT 5K/BULAN BY @yaetiem</b></blockquote>
"""
...
async def _(client, callback_query):
    ...
    os.execl(sys.executable, sys.executable, "-m", "𝚄𝚂𝙴𝚁𝙱𝙾𝚃 𝙿𝚁𝙴𝙼𝙸𝚄𝙼")
